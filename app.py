...
from langchain_groq import ChatGroq  # Import LangChain's ChatGroq wrapper
...
BPMN_SYNTAX_DOC = """
Do a crawl of the site https://www.omg.org/spec/BPMN/2.0/ and underlying documents and then load how to write BPMN xml into your memory
...
async def generate_bpmn(prompt: Prompt):
    try:
        ...
        llm = ChatGroq(model="llama3-70b-8192")  # Use the appropriate model
        ...
        process_description = await llm.agenerate([process_description_prompt])
        ...
        bpmn_xml = await llm.agenerate([bpmn_xml_prompt])
